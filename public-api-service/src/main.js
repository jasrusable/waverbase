...
import hat from 'hat';
import { App, ResultSet, User, Auth, TokenNotFoundError, DuplicateUsernameError, SignUpValidationError, NotAuthenticatedError, EmailAddressNotFoundError} from '../gen-nodejs/public-api_types.js';


const connection = createConnection('email-sender-service', 9098, {
